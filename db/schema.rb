# db/structure.sql is probably being used now and this is out of date
...
ActiveRecord::Schema[7.0].define(version: 2022_09_09_184505) do
...
#   Unknown type 'geometry' for column 'the_geom'
  ...
  create_table "maps_streets", id: false, force: :cascade do |t|
    t.bigint "map_id", null: false
    t.bigint "street_id", null: false
    t.index ["map_id", "street_id"], name: "index_maps_streets_on_map_id_and_street_id"
    t.index ["street_id", "map_id"], name: "index_maps_streets_on_street_id_and_map_id"
  end
...
#   Unknown type 'geometry' for column 'the_geom'
  ...
  create_table "streets", force: :cascade do |t|
    ...
    t.string "date_earliest"
    t.string "date_latest"
    t.string "cross_streets"
    t.string "number_of_blocks"
    t.text "ref1"
    t.text "ref2"
    t.text "ref3"
    t.text "notes"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.string "extent_array"
    t.json "extent_json"
    t.string "city", default: "Los Angeles"
    t.decimal "extent_length"
    t.text "references"
  end
