Rails.application.configure do
  ...
  # config.assets.js_compressor = :uglifier # https://github.com/lautis/uglifier/issues/127
  ...
  # config.action_controller.asset_host = 'http://assets.historicstreets.la'
  ...
  # config.active_job.queue_name_prefix = "la_hist_street_#{Rails.env}"
  ...
  ActionMailer::Base.smtp_settings = {
    ...
    :domain         => 'heroku.com', # this or historicstreets.la didn't seem to matter
